...
public class TelaConsulta extends JFrame {
	...
	public TelaConsulta() {
		...
		JButton btnPrateleirasCom = new JButton("Prateleiras com 2 produtos");
		btnPrateleirasCom.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				ArrayList<Prateleira> resultado = Fachada.consultarPrateleirasNProdutos(2);
				String texto = "Listagem de prateleiras com 2 produtos: \n";
